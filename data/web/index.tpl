...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td>{{row.id}}</td>
                <td><a href="/viper/file/{{p}}/{{row.sha256}}">{{row.name}}</a></td>
...
% if num_pages > 0:
    ...
    <div class="text-center">
        <ul class="pagination">
          ...
          <li><a href="/viper/project/{{p}}?page={{cur_page-1}}">&laquo;</a></li>
          ...
          <a href="/viper/project/{{p}}?page={{i}}">{{i}}</a></li>
          % end
          <li><a href="/viper/project/{{p}}?page={{cur_page+1}}">&raquo;</a></li>
        </ul>
    </div>
